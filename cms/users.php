                            ...
                            if($all_rows){
                              foreach($all_rows as $key => $user_info){
                                ...
                                <tr>
                                  ...
                                  <td>
                                    <span class="badge badge-<?php echo ($user_info -> status == 'active') ? 'success' : 'danger' ?>"><?php echo ucfirst($user_info -> status) ?></span>
                                  </td>
                                  ...
                                  <td>
                                    ...
                                    <a href="user-form.php?id=<?php echo $user_info->id; ?>" title="Edit" class="btn btn-success btn-sm" style="border-radius:50%">
                                      <i class="fa fa-edit"></i>
                                    </a>
                                    <a href="process/users.php?id=<?php echo $user_info->id; ?>" title="Delete" onclick="return confirm('Are you sure you want to delete this user?');"class="btn btn-danger btn-sm" style="border-radius:50%">
