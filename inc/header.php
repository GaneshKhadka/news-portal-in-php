...
<head>
    ...
    <meta name="keywords" content="<?php echo (isset($meta['keywords'])) ? $meta['keywords'] : META_KEYWORDS ?>">
    ...
    <div class="container" style="margin-top: 20px">
        <div class="row">
            <div class="col-12">
                ...
                <img src="<?php echo UPLOAD_URL.'/advertisement/'.$home_1[0]->image?>" alt="<?php echo $home_1[0]->title ?>" class="img img-fluid">
                </a>
            </div>
        </div>
    </div>
                ...
                <div class="col-md-6">
                    <div class="info">
                        <a href="<?php echo $home_2[0]->link ?>" target="_ads">
                         <img src="<?php echo UPLOAD_URL.'/advertisement/'.$home_2[0]->image ?>" style="width: 100%;" alt="<?php echo $home_2[0]->title ?>">
                        </a>
                    </div>
                </div>
                 <?php } ?>
